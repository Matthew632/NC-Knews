...
describe('/api', () => {
  ...
  describe('/articles', () => {
    ...
    it('GET status:200 responds with an total_count property', () => request
    ...
    it('check author query on articles with total_count', () => request
  ...
  describe('/articles/:article_id/comments', () => {
    ...
    it('GET status:200 responds with an array of comment objects and total count', () => request
      .get('/api/articles/5/comments?limit=1')
      .expect(200)
      .then((response) => {
        expect(response.body).to.be.an('object');
        expect(response.body.comments).to.have.lengthOf(1);
        expect(response.body.total_count).to.eql(2);
        expect(response.body.comments[0]).to.contain.keys(
          'comment_id',
          'votes',
          'created_at',
    ...
    it('check comment delete', () => request.delete('/api/comments/2').expect(204));
  });
  describe('/users', () => {
